...
public class WordCount {
    ...
    public static void main(String[] a){
        ...
        sc.textFile("hdfs://192.168.4.106:9000/README.md")
                ...
                //一行一个元素--->一个单词一个元素
                .flatMap((String o) -> Arrays.asList(o.split(" ")).iterator())

                //一个单词一个元素--->[单词,1]为元素
                .mapToPair((String s) -> new Tuple2<>(new Text(s),new IntWritable(1)))

                //对相同的单词 的个数进行聚合(相加)
                .reduceByKey((IntWritable i, IntWritable i2) -> new IntWritable(i.get()+i2.get()))
